  ...
  return (
    <>
        ...
        <div className="relative container min-h-[88vh] flex items-center py-24">
          <div className="max-w-2xl text-primary-foreground">
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-xs font-medium uppercase tracking-[0.2em] mb-6 border-white/20 text-primary-foreground/90"
            >
            ...
            >
              <Button asChild size="lg" className="rounded-full bg-gradient-accent text-accent-foreground hover:opacity-95 shadow-glow">
                <Link to="/menu">
                  Explore the menu <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="rounded-full border-white/40 bg-white/10 text-primary-foreground hover:bg-white/20 hover:text-primary-foreground backdrop-blur">
            ...
            <motion.div
              ...
              className="mt-12 flex flex-wrap gap-6 text-sm text-primary-foreground/80"
            >
      ...
      <section className="container py-16 md:py-24">
        <motion.div
          {...fadeUp}
          className="relative overflow-hidden rounded-3xl bg-gradient-accent p-10 md:p-16 text-accent-foreground shadow-elegant"
        >
