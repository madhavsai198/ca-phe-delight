              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-x-3 gap-y-1 text-muted-foreground text-sm">
                    ...
                    <span>·</span>
                    <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-accent inline-flex items-center gap-1"><Instagram className="h-3.5 w-3.5" />Instagram</a>
                  </div>
                </div>
              </li>
            </ul>
